...
#include "Eos_map.h"
  ...
  real, save :: nr_eos_dens, nr_eos_eint, nr_eos_pres, nr_eos_entr, &
                nr_eos_xn(SPECIES_BEGIN:SPECIES_END)
  real, dimension(2,2), save :: nr_eos_deriv
  real, dimension(2), save :: nr_eos_scale
  integer, save :: nr_eos_mode, nr_eos_k
  logical, save :: nr_eos_limited
  integer, save :: nr_eos_lim_cnt
  ...
  real, save :: eos_smallgamc, eos_largegamc
  ...
  logical, save :: eos_forceConstantInput, eos_failed
